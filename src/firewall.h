...
typedef enum _t_fw_marks {
    ...
    FW_MARK_PROBATION = 80000,//524288, /**< @brief The client is in probation period and must be authenticated 
			    //@todo: VERIFY THAT THIS IS ACCURATE*/
    FW_MARK_KNOWN = 10000000 ,//268435456,  /**< @brief The client is known to the firewall */
